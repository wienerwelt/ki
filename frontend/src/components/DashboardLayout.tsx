                        ...
                        {user?.role === 'admin' && (
                            <>
                                ...
                                <List component="div" disablePadding sx={{ pl: 4 }}>
                                    <ListItem button component={RouterLink} to="/admin/statistics" onClick={toggleDrawer(false)}><QueryStatsIcon sx={{ mr: 2 }} /><ListItemText primary="Statistiken" /></ListItem> {/* NEU */}
